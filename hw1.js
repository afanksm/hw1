...
console.log("Currently it is "+weatherData.current.temperature+ " and "+ weatherData.current.conditions+". Tomorrow it will be "+ day1.temperature+" and "+day1.conditions+".");
